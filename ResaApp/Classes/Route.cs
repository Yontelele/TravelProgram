...
public class Route
{
    ...
    Math.Round(12742 * Math.Asin(Math.Sqrt(0.5 - Math.Cos((Destination.Latitude - Origin.Latitude) *
    0.017453292519943295) / 2 + Math.Cos(Origin.Latitude * 0.017453292519943295) * Math.Cos(Destination.Latitude * 0.017453292519943295) *
    (1 - Math.Cos((Destination.Longitude - Origin.Longitude) * 0.017453292519943295)) / 2)));
